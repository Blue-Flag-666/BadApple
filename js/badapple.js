$(function() {
    var BadApple = {
        ...
        init: function() {
            ...
            me.ctx.font = '12px monospace'; //monospace
            
            $("#audio").attr("src","https://cdn.jsdelivr.net/gh/Galaxy-Studio-Code/BadApple@main/media/music.mp3");
            $("#audio")[0].play();
        },
        load_data: function (index, count, fn) {
            ...
            if (!me.is_loading[index]) {
                ...
                $.get('data/data_' + index + '.txt', function (data) {
                    // finish loading
